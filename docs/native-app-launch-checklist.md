...
- [x] Fade in the complete fixed-size startup brand once after the native splash, render it immediately for reduced motion, and never replay the entrance during the root-route handoff
