...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: "#9f7aea", fontSize: 10, lineHeight: 14, fontFamily: "Inter_800ExtraBold", textTransform: "uppercase", letterSpacing: 1.45, marginBottom: 10 },
  title: { color: "#f8fafc", fontSize: 34, lineHeight: 40, fontFamily: "Inter_800ExtraBold", letterSpacing: -1.25 },
  description: { color: "#8e9db4", fontSize: 13, lineHeight: 20, fontFamily: "Inter_500Medium", maxWidth: 690, marginTop: 8 },
  ...
  primaryButtonText: { color: "#ffffff", fontSize: 11, fontFamily: "Inter_800ExtraBold" },
  ...
  statLabel: { color: "#8492a8", fontSize: 9, fontFamily: "Inter_800ExtraBold", letterSpacing: 0.75, textTransform: "uppercase" },
  statValue: { color: "#f8fafc", fontSize: 24, lineHeight: 30, fontFamily: "Inter_800ExtraBold", letterSpacing: -0.75, marginTop: 5 },
  statDetail: { color: "#6f7f97", fontSize: 9, lineHeight: 14, fontFamily: "Inter_600SemiBold", marginTop: 4 },
  ...
  panelTitle: { color: "#eef3fb", fontSize: 17, lineHeight: 22, fontFamily: "Inter_800ExtraBold", letterSpacing: -0.35 },
  panelSubtitle: { color: "#74839a", fontSize: 10, lineHeight: 15, fontFamily: "Inter_500Medium", marginTop: 4 },
  ...
  columnLabel: { color: "#65738a", fontSize: 8, fontFamily: "Inter_800ExtraBold", textTransform: "uppercase", letterSpacing: 0.8 },
  ...
  rowName: { color: "#dce5f2", fontSize: 11, lineHeight: 16, fontFamily: "Inter_700Bold" },
  rowMeta: { color: "#6f7d93", fontSize: 9, lineHeight: 13, fontFamily: "Inter_500Medium", marginTop: 2 },
  rowText: { color: "#91a0b5", fontSize: 10, fontFamily: "Inter_600SemiBold" },
  rowMoney: { color: "#e8eef7", fontSize: 11, fontFamily: "Inter_800ExtraBold", fontVariant: ["tabular-nums"] },
  ...
  pillText: { fontSize: 8, fontFamily: "Inter_800ExtraBold", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  emptyRow: { minHeight: 110, alignItems: "center", justifyContent: "center", gap: 9 }, emptyText: { color: "#75839a", fontSize: 11, fontFamily: "Inter_500Medium" },
  ...
  dayTopline: { minHeight: 25, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 }, dayNumber: { color: "#dce6f4", fontSize: 13, fontFamily: "Inter_800ExtraBold" }, dayBalance: { color: "#f8fafc", fontSize: 16, fontFamily: "Inter_800ExtraBold", marginTop: 14 }, dayLabel: { color: "#66758c", fontSize: 8, fontFamily: "Inter_600SemiBold", marginTop: 3 }, dayFooter: { marginTop: "auto", flexDirection: "row", alignItems: "center", gap: 6 }, daySignal: { width: 6, height: 6, borderRadius: 3 }, dayNet: { color: "#9aa8bb", fontSize: 9, fontFamily: "Inter_700Bold" },
  goalGrid: { flexDirection: "row", flexWrap: "wrap", gap: 14 }, goalCard: { flexBasis: "31%", flexGrow: 1, minWidth: 280, minHeight: 220, borderRadius: 20, borderWidth: 1, borderColor: "rgba(167,139,250,0.16)", backgroundColor: "rgba(8,14,31,0.9)", padding: 19 }, goalCardTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, goalIcon: { width: 36, height: 36, borderRadius: 11, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(167,139,250,0.20)", backgroundColor: "rgba(139,92,246,0.12)" }, goalName: { color: "#f1f5f9", fontSize: 17, lineHeight: 22, fontFamily: "Inter_800ExtraBold", marginTop: 23 }, goalAmount: { color: "#e8eef7", fontSize: 15, fontFamily: "Inter_800ExtraBold", marginTop: 7 }, goalTarget: { color: "#718097", fontSize: 10, fontFamily: "Inter_600SemiBold" }, progressTrack: { width: "100%", height: 7, borderRadius: 999, backgroundColor: "rgba(148,163,184,0.13)", overflow: "hidden", marginTop: 22 }, progressFill: { height: 7, borderRadius: 999, backgroundColor: "#8b5cf6", shadowColor: "#8b5cf6", shadowOpacity: 0.55, shadowRadius: 8, shadowOffset: { width: 0, height: 0 } }, goalFooter: { flexDirection: "row", justifyContent: "space-between", marginTop: 10 }, goalPercent: { color: "#a899ff", fontSize: 9, fontFamily: "Inter_700Bold" }, goalDate: { color: "#69778d", fontSize: 9, fontFamily: "Inter_600SemiBold" },
  reportGrid: { flexDirection: "row", gap: 14 }, reportMetric: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 18 }, reportLabel: { color: "#8f9db1", fontSize: 10, fontFamily: "Inter_600SemiBold" }, reportValue: { color: "#e9eef7", fontSize: 12, fontFamily: "Inter_800ExtraBold" }, reportTrack: { height: 9, borderRadius: 999, backgroundColor: "rgba(148,163,184,0.12)", overflow: "hidden", marginTop: 8 }, reportFillPurple: { height: 9, borderRadius: 999, backgroundColor: "#8b5cf6" }, reportFillGreen: { height: 9, borderRadius: 999, backgroundColor: "#22c55e" }, summaryRow: { minHeight: 45, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottomWidth: 1, borderBottomColor: "rgba(148,163,184,0.08)" }, summaryLabel: { color: "#8593a8", fontSize: 10, fontFamily: "Inter_600SemiBold" }, summaryValue: { color: "#dce5f2", fontSize: 11, fontFamily: "Inter_800ExtraBold" }, summaryTotal: { borderBottomWidth: 0, marginTop: 4 }, summaryTotalLabel: { color: "#c4b5fd", fontSize: 11, fontFamily: "Inter_800ExtraBold" }, summaryTotalValue: { color: "#6ee7b7", fontSize: 15, fontFamily: "Inter_800ExtraBold" },
  settingRow: { minHeight: 72, flexDirection: "row", alignItems: "center", gap: 13, paddingHorizontal: 8 }, settingIcon: { width: 36, height: 36, borderRadius: 11, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(167,139,250,0.18)", backgroundColor: "rgba(139,92,246,0.10)" }, settingValue: { color: "#e4eaf4", fontSize: 11, fontFamily: "Inter_800ExtraBold", marginRight: 12 },
  footer: { minHeight: 54, alignItems: "center", justifyContent: "center" }, footerText: { color: "#4e5b70", fontSize: 9, fontFamily: "Inter_600SemiBold" },
});
