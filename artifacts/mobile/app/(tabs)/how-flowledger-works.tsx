...
const styles = StyleSheet.create({
  ...
  scoreHero: { borderWidth: 1, borderRadius: 20, padding: 16, flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 14 }, scoreValue: { fontSize: 30, fontFamily: "Inter_800ExtraBold", marginTop: 2 }, scoreStatus: { fontSize: 14, fontFamily: "Inter_800ExtraBold" },
